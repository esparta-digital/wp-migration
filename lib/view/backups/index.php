            ...
            <div class="ai1wm-holder">
                ...
                <form action="" method="post" id="ai1wm-backups-form" class="ai1wm-clear">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="ai1wm-column-actions ai1wm-backup-actions">
                                    <a href="<?php echo ai1wm_backup_url( array( 'archive' => esc_attr( $backup['filename'] ) ) ); ?>"
                                        class="ai1wm-button-green ai1wm-backup-download">
                                        <i class="ai1wm-icon-arrow-down"></i>
                                        <span><?php _e( 'Download', AI1WM_PLUGIN_NAME ); ?></span>
                                    </a>
                                    <a href="#" data-archive="<?php echo esc_attr( $backup['filename'] ); ?>"
                                        class="ai1wm-button-gray ai1wm-backup-restore">
                                        <i class="ai1wm-icon-cloud-upload"></i>
                                        <span><?php _e( 'Restore', AI1WM_PLUGIN_NAME ); ?></span>
                                    </a>
                                    <a href="#" data-archive="<?php echo esc_attr( $backup['filename'] ); ?>"
                                        class="ai1wm-button-red ai1wm-backup-delete">
                    ...
                    <div class="ai1wm-backups-create">
                        ...
                        <p>
                            <a href="<?php echo esc_url( network_admin_url( 'admin.php?page=ai1wm_export' ) ); ?>"
